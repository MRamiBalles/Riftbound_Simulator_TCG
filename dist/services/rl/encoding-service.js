...
exports.ActionSpaceMapper = exports.EncodingService = void 0;
const KEYWORD_MAP = {
...
class EncodingService {
     ...
     */
    static encodeKeywords(keywords) {
        let mask = 0;
        keywords.forEach(k => {
...
class ActionSpaceMapper {
     ...
     */
    static mapToEngine(index, state, playerId) {
        const me = state.players[playerId];
        // 0: PASS
        if (index === 0)
...
exports.ActionSpaceMapper = ActionSpaceMapper;
