...
exports.roboticArm = exports.RoboticArmService = void 0;
const ai_service_1 = require("./ai-service");
class RoboticArmService {
    static instance;
    static isUIBusy = false;
    config = {
     ...
     */
    static setUIBusy(busy) {
        this.isUIBusy = busy;
    }
    emitIntention(action) {
     ...
     */
    getLogNormalDelay(meanMs, sigma) {
    ...
    static async executeAction(action, onExecute) {
        const instance = this.getInstance();
        if (RoboticArmService.isUIBusy)
            return;
    ...
    async processGameState(state, onAction) {
        if (!this.isRunning || RoboticArmService.isUIBusy)
            return;
        ...
        try {
            const action = await ai_service_1.AIService.getAction(state);
            if (action) {
...
exports.RoboticArmService = RoboticArmService;
exports.roboticArm = RoboticArmService.getInstance();
